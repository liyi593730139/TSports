...
public class CPURemoteMonitor4Linux implements Monitor {

	/**
	* 客户端检测脚本相对路径。
	*/
	public static final String INVOKE_CMD = "vmstat 1 3";
    ...
    */
    public CPURemoteMonitor4Linux(String taskID, Client client) {
        this.taskId = taskID;
        this.client = client;
    ...
    public static void main(String[] args) throws Exception{
        CPURemoteMonitor4Linux mon = new CPURemoteMonitor4Linux("0000", new Client("127.0.0.1", 50000));
        mon.detect();
    }
}
